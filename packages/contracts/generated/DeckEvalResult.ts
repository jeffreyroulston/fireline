...
export type DeckEvalResult = { simType: SimType, samples: number, damages: Array<number>, hands: Array<SampleHand>, mean: number, p10: number, p50: number, p90: number, max: number, min: number, 
/**
