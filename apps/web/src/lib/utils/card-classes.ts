...
import { typeKicker } from "@/lib/utils/typography";

export const kickerClass = typeKicker;
...
export const handCardClass =
  "block w-full min-w-0 border-0 bg-transparent p-0 text-left cursor-pointer focus-visible:outline focus-visible:outline-[3px] focus-visible:outline-accent/60 focus-visible:outline-offset-2";

export const handCardImageClass =
  "block aspect-[5/7] w-full border border-foreground/20 bg-foreground/[0.04] object-cover transition-[border-color,transform] duration-150 ease-in-out group-hover:-translate-y-[3px] group-hover:border-foreground";

export const handCardFallbackInnerClass =
...
export const cardTileMetaClass =
